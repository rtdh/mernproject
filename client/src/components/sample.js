...
const initialValues = {
            district: '', mandal: '', school:'', mandals: [], schools: [],
            name: '', surname: '', designation: '', dob:'', dojs:'', dor: '', 
            retirementAge: '', retirementAgeDisabled : false,
            subjects : [''], gender: '', photo: '', photoVisible: false,
...
const validationSchema = Yup.object().shape({
    ...
    photo : Yup.string().required('Upload a photo'),
        ...
        >
    {
        formik =>{
            ...
            <Form id="addteacherForm" encType="multipart/form-data">
                <h3 className="display-4">Add New Entry</h3>
                {/* First Row */}
                <div className="row my-4">
                    ...
                    <div className="col-lg-4">
                        <div className="form-group">
                            ...
                            onChange={(e)=>this.onSchoolChange(e)} value={this.state.school}
                            onBlur={handleBlur}
                            >
                                <option value="">Select</option>
                ...
                <div className="row my-4">
                    ...
                    <div className="col-lg-2">
                        <div className="form-group">
                            ...
                            value={this.state.phto} key={this.state.inputKey}
                ...
                {this.state.isUpdated ? <div>pls wait... record is saving</div> : null}    
            </Form>
            )
        }
    }
